...
public class SteppeJungleMap implements IWorldMap,IPositionChangeObserver {
    ...
    //statistic
    private int deadAnimalCounter;
    private int CopulationCounter;
    ...
    private boolean removeAnimal(Animal a,Vector2d position2){
        ...
        if(l == null) throw new IllegalArgumentException("Animal" + a.getPosition() + " -> "+position+" already not exist in the map");
